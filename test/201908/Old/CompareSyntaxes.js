...
describe("Wait/DateTime old/new implementation simple", () => {
  it("Timestamp", () => {
    ...
    expect(DateTime.get(New, "UTC", baseDate)).to.be.equals(Old);
  });
  ...
  it("Seconds", () => {
    ...
    expect(Duration.get(New, "UTC", baseDate)).to.be.equals(Old);
  });
...
describe("Wait/DateTime old/new implementation special cases 2", () => {
  ...
  it("Next mondays at 8 am, or today if monday before 8 am", () => {
    ...
    expect(DateTime.get(New, "UTC", date)).to.be.equals(Old);
  });
